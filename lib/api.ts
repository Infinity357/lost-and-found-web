...
export async function fetchLostItems(): Promise<LostItem[]> {
  try {
    const response = await fetch("https://lost-and-found-api-2.onrender.com/lost", {
      cache: "no-store",
    })
...
export async function fetchUserLostItems(userId: string): Promise<LostItem[]> {
  try {
    const response = await fetch(`https://lost-and-found-api-2.onrender.com/lost?userId=${userId}`, {
      cache: "no-store",
    })
...
export async function fetchFoundItems(): Promise<FoundItem[]> {
  try {
    const response = await fetch("https://lost-and-found-api-2.onrender.com/found", {
      cache: "no-store",
    })
...
export async function fetchUserFoundItems(userId: string): Promise<FoundItem[]> {
  try {
    const response = await fetch(`https://lost-and-found-api-2.onrender.com/found?userId=${userId}`, {
      cache: "no-store",
    })
...
export async function fetchLostItemById(itemId: string): Promise<LostItem | null> {
  try {
    const response = await fetch(`https://lost-and-found-api-2.onrender.com/lost/${itemId}`, {
      cache: "no-store",
    })
...
export async function fetchFoundItemById(itemId: string): Promise<FoundItem | null> {
  try {
    const response = await fetch(`https://lost-and-found-api-2.onrender.com/found/${itemId}`, {
      cache: "no-store",
    })
...
export async function fetchUserInfo(userId: string): Promise<User> {
  try {
    const response = await fetch(`https://lost-and-found-api-2.onrender.com/auth?userId=${userId}`, {
      cache: "no-store",
    })
...
export async function fetchLostItemClaims(itemId: string): Promise<Claim[]> {
  try {
    const response = await fetch(`https://lost-and-found-api-2.onrender.com/lost/${itemId}/claims`, {
      cache: "no-store",
    })
...
export async function fetchFoundItemClaims(itemId: string): Promise<Claim[]> {
  try {
    const response = await fetch(`https://lost-and-found-api-2.onrender.com/found/${itemId}/claims`, {
      cache: "no-store",
    })
...
export async function submitFoundClaim(itemId: string): Promise<void> {
  ...
  try {
    const response = await fetch(`https://lost-and-found-api-2.onrender.com/lost/${itemId}/claim`, {
      method: "POST",
      headers: {
...
export async function submitLostClaim(itemId: string): Promise<void> {
  ...
  try {
    const response = await fetch(`https://lost-and-found-api-2.onrender.com/found/${itemId}/claim`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export async function uploadImage(file: File): Promise<string> {
  try {
    ...
    const response = await fetch("https://lost-and-found-api-2.onrender.com/upload", {
      method: "POST",
      body: formData,
    })
...
export async function submitClaim(
  ...
  try {
    const response = await fetch(`https://lost-and-found-api-2.onrender.com/claims/${itemId}`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
